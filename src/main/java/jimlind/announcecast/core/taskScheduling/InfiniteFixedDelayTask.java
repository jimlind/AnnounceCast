...
@Slf4j
public abstract class InfiniteFixedDelayTask extends InfiniteTask {
   ...
   */
  public InfiniteFixedDelayTask(
      long initialDelayMillis, long subsequentDelayMillis, long timeoutMillis) {
