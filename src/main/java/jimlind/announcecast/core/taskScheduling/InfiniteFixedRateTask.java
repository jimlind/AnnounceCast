...
@Slf4j
public abstract class InfiniteFixedRateTask extends InfiniteTask {
   ...
   */
  public InfiniteFixedRateTask(long initialDelayMillis, long periodMillis, long timeoutMillis) {
